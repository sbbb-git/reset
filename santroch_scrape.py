#!/usr/bin/env python3
"""Fréquentation Sant-Roch Paris (Mariana Tek).

Tenant : https://santroch.marianatek.com — région Paris = "France" (10155).
...
TENANT = "https://santroch.marianatek.com"
REGION = 48541  # Paris
...
CONFIG = {
    "key": "santroch", "brand": "SANT-ROCH PARIS",
    "host": "santroch.marianatek.com",
    "store": "santroch_data.json", "html": "santroch.html",
    "csv": "santroch_seances.csv", "price": 20,
    "accent": "#4a7c7e", "accent2": "#7daeb1",
}
