#!/usr/bin/env python3
"""Auto-discovery fitness général IDF — réutilise les détecteurs de
pilates_extension_discover.py sur le catalogue fitness_extension_brands.json.
"""
import json
import os
import sys
...
def main():
    ...
    print(f"\n[FITNESS] Discovery : {n_new} nouveaux + {n_skip} déjà résolus + {n_unknown} unknown / {len([k for k in brands if not k.startswith('_')])} brands")
