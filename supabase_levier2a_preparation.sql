-- ============================================================================
-- LEVIER 2a — PRÉPARATION (additif, rien n'est supprimé)
-- ============================================================================
--
...
-- Ce fichier ne fait qu'AJOUTER : tables de correspondance, colonnes,
-- backfill, nouvel index. Le schéma actuel continue de fonctionner tel
-- quel. La bascule destructive est dans levier2b, à ne jouer QU'APRÈS
-- avoir poussé le sync qui envoie club_id / court_num et vérifié un run
-- vert.
