...
CONFIG = {"key":"lecercle","brand":"LE CERCLE BOXING","company":2443,
          ...
          # "Studio Bastille" est exposé par l'API bsport mais le studio n'existe pas
          # côté client (capacité aberrante 38, 0 réservation sur toutes les séances).
          "skip_lieux":["Studio Bastille"],
