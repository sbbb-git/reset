...
BRANDS = {
    ...
    "punch":         {"label": "Punch",         "color": "#263fff", "category": "Boxe",            "platform": "Mindbody proxy",  "price_default": 20},
    "dynamo":        {"label": "Dynamo",        "color": "#faa619", "category": "Cycling",         "platform": "Mindbody proxy",  "price_default": 20},
    "riise":         {"label": "Riise",         "color": "#c25a3f", "category": "Yoga / Wellness", "platform": "Mindbody proxy",  "price_default": 20},
    "thenewme":      {"label": "The New Me",    "color": "#b8895e", "category": "Pilates",         "platform": "bsport",          "price_default": 20},
    "lecercle":      {"label": "Le Cercle",     "color": "#d4453a", "category": "Boxe",            "platform": "bsport",          "price_default": 20},
    "spacecycle":    {"label": "Space Cycle",   "color": "#16b3c6", "category": "Cycling",         "platform": "bsport",          "price_default": 20},
    "poses":         {"label": "Poses",         "color": "#b06a8f", "category": "Pilates",         "platform": "bsport",          "price_default": 20},
    "barrys":        {"label": "Barry's",       "color": "#e2231a", "category": "Bootcamp",        "platform": "Mariana Tek",     "price_default": 20},
    "episod":        {"label": "Episod",        "color": "#e8c14d", "category": "Bootcamp",        "platform": "resamania",       "price_default": 30},
    "belly":         {"label": "Belly",         "color": "#e0699b", "category": "Pilates",         "platform": "bsport",          "price_default": 20},
    "athletx":       {"label": "AthletX",       "color": "#e0322c", "category": "Bootcamp",        "platform": "bsport",          "price_default": 20},
    "senseclub":     {"label": "Sense-Club",    "color": "#9b7ff0", "category": "Pilates",         "platform": "Mindbody widget", "price_default": 25},
    "dna":           {"label": "DNA Pilates",   "color": "#c9a24b", "category": "Pilates",         "platform": "Mindbody widget", "price_default": 25},
    "le33foch":      {"label": "Le 33 Foch",    "color": "#c4a361", "category": "Bootcamp",        "platform": "Mindbody widget", "price_default": 30},
    "banote":        {"label": "Banote",        "color": "#c9a24b", "category": "Pilates",         "platform": "Mindbody widget", "price_default": 25},
    "santroch":      {"label": "Sant-Roch",     "color": "#4a7c7e", "category": "Yoga / Wellness", "platform": "Mariana Tek",     "price_default": 25},
    "snakeandtwist": {"label": "Snake & Twist", "color": "#3a7d44", "category": "Pilates",         "platform": "Arketa",          "price_default": 22},
    "burningbar":    {"label": "Burning Bar",   "color": "#ff5a1f", "category": "Pilates",         "platform": "Mindbody widget", "price_default": 25},
